...
class SecondViewController: UIViewController {
    ...
    var nameContainer : String?                 //step 1 - forward data passing - creating container
    ...
    func initViews(){
        ...
        self.welcomeMessageLabel.text = nameContainer           //step 3 -- binding the data from container with text property of label
